...
sleep 1
wget -q -O /usr/bin/auto-set "https://raw.githubusercontent.com/jhoker/multi-ws/main/xray/auto-set.sh" && chmod +x /usr/bin/auto-set 
wget -q -O /usr/bin/crtxray "https://raw.githubusercontent.com/jhoker/multi-ws/main/xray/crt.sh" && chmod +x /usr/bin/crtxray 
sleep 1
